...
{
    class PrivateMemoryAllocator : IDisposable
    {
        ...
        public PrivateMemoryAllocator(int blockAlignment)
        {
            _blocks = new List<Block>();
            _blockAlignment = blockAlignment;
        }

        public unsafe PrivateMemoryAllocation Allocate(ulong size, ulong alignment)
        {
            ...
            for (int i = 0; i < _blocks.Count; i++)
            {
                ...
                if (block.Size >= size)
                {
                    ...
                    {
                        return new PrivateMemoryAllocation(this, block, offset, size);
                    }
                }
            }
            ...
            var memory = new MemoryBlock(blockAlignedSize, MemoryAllocationFlags.Mirrorable | MemoryAllocationFlags.NoMap);
            var newBlock = new Block(memory, blockAlignedSize);
            ...
            return new PrivateMemoryAllocation(this, newBlock, newBlockOffset, size);
        }
