...
namespace Ryujinx.Cpu.Nce
{
    static class NcePatcher
    {
        ...
        {
            public readonly IVirtualMemoryManagerTracked MemoryManager;
            public ulong PatchRegionAddress;
            public ulong PatchRegionSize;

            public Context(IVirtualMemoryManagerTracked memoryManager, ulong patchRegionAddress, ulong patchRegionSize)
            {
            ...
            ulong patchRegionSize)
        {
            ...
            ulong patchRegionConsumed = BitUtils.AlignUp(context.PatchRegionAddress - patchRegionAddress, 0x1000);
        ...
        private static void PatchInstruction(IVirtualMemoryManagerTracked memoryManager, ulong instructionAddress, ulong targetAddress)
        {
