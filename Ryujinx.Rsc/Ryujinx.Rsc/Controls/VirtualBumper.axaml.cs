...
{
    public partial class VirtualBumper : UserControl, IVirtualControl
    {
        private object _faceLabel;
        private GamepadButtonInputId gamepadButtonInputId;

        public VirtualBumper()
        {
            InitializeComponent();
        }
        ...
        public GamepadButtonInputId ButtonInputId
        {
            ...
            set
            {
                ...
                {
                    case GamepadButtonInputId.LeftShoulder:
                        FaceLabel = "L";
                        Border.Classes.Add("left");
                        Border.Classes.Remove("right");
                        break;
                    case GamepadButtonInputId.RightShoulder:
                        FaceLabel = "R";
