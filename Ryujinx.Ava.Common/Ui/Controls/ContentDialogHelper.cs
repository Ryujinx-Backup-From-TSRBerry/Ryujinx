...
namespace Ryujinx.Ava.Common.Ui.Controls
{
    public static class ContentDialogHelper
    {
        ...
        public async static Task<UserResult> ShowDeferredContentDialog(
            ...
            Func<TopLevel, Task> doWhileDeferred = null)
        {
...
#pragma warning restore CS4014 // Because this call is not awaited, execution of the current method continues before the call is completed
        ...
        public static async Task<UserResult> CreateConfirmationDialog(
            string primaryText,
            string secondaryText,
        ...
        public static UpdateWaitWindow CreateWaitingDialog(string mainText, string secondaryText)
        {
            return new(mainText, secondaryText);
        }

        public static async Task CreateUpdaterInfoDialog(string primary, string secondaryText)
        {
        ...
        public static async Task CreateWarningDialog(string primary, string secondaryText)
        {
            await ShowContentDialog(
        ...
        public static async Task CreateErrorDialog(string errorMessage, string secondaryErrorMessage = "")
        {
        ...
        public static async Task<bool> CreateChoiceDialog(string title, string primary, string secondaryText)
        {
        ...
        public static async Task<bool> CreateExitDialog()
        {
        ...
        public static async Task<bool> CreateStopEmulationDialog()
        {
            return await CreateChoiceDialog(
        ...
        public static async Task<string> CreateInputDialog(
            string title,
            string mainText,
            string subText,
