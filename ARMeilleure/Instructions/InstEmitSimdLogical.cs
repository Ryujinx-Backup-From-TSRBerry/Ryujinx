...
namespace ARMeilleure.Instructions
{
    static partial class InstEmit
    {
        public static void And_V(ArmEmitterContext context)
        {
            ...
            {
                InstEmitSimdNativeArmHelper.EmitVectorBinaryOp(context, Intrinsic.Arm64AndV);
            }
        ...
        public static void Bic_V(ArmEmitterContext context)
        {
            if (Optimizations.UseAdvSimd)
            {
                InstEmitSimdNativeArmHelper.EmitVectorBinaryOp(context, Intrinsic.Arm64BicV);
            }
            else if (Optimizations.UseSse2)
            {
                OpCodeSimdReg op = (OpCodeSimdReg)context.CurrOp;
        ...
        public static void Bif_V(ArmEmitterContext context)
        {
            if (Optimizations.UseAdvSimd)
            {
                InstEmitSimdNativeArmHelper.EmitVectorBinaryOp(context, Intrinsic.Arm64BifV);
            }
            else
            {
        ...
        public static void Bit_V(ArmEmitterContext context)
        {
            if (Optimizations.UseAdvSimd)
            {
                InstEmitSimdNativeArmHelper.EmitVectorBinaryOp(context, Intrinsic.Arm64BitV);
            }
            else
            {
        ...
        public static void Bsl_V(ArmEmitterContext context)
        {
            if (Optimizations.UseAdvSimd)
            {
                InstEmitSimdNativeArmHelper.EmitVectorBinaryOp(context, Intrinsic.Arm64BslV);
            }
            else if (Optimizations.UseSse2)
            {
                OpCodeSimdReg op = (OpCodeSimdReg)context.CurrOp;
        ...
        public static void Eor_V(ArmEmitterContext context)
        {
            if (Optimizations.UseAdvSimd)
            {
                InstEmitSimdNativeArmHelper.EmitVectorBinaryOp(context, Intrinsic.Arm64EorV);
            }
            else if (Optimizations.UseSse2)
            {
                OpCodeSimdReg op = (OpCodeSimdReg)context.CurrOp;
        ...
        public static void Orn_V(ArmEmitterContext context)
        {
            if (Optimizations.UseAdvSimd)
            {
                InstEmitSimdNativeArmHelper.EmitVectorBinaryOp(context, Intrinsic.Arm64OrnV);
            }
            else if (Optimizations.UseSse2)
            {
                OpCodeSimdReg op = (OpCodeSimdReg)context.CurrOp;
        ...
        public static void Orr_V(ArmEmitterContext context)
        {
            if (Optimizations.UseAdvSimd)
            {
                InstEmitSimdNativeArmHelper.EmitVectorBinaryOp(context, Intrinsic.Arm64OrrV);
            }
            else if (Optimizations.UseSse2)
            {
                OpCodeSimdReg op = (OpCodeSimdReg)context.CurrOp;
