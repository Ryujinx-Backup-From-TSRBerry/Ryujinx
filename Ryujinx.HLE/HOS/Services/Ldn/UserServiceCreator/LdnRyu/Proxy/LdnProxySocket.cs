...
namespace Ryujinx.HLE.HOS.Services.Ldn.UserServiceCreator.LdnRyu.Proxy
{
    ...
    class LdnProxySocket : ISocketImpl
    {
        ...
        public void SetSocketOption(SocketOptionLevel optionLevel, SocketOptionName optionName, int optionValue)
        {
            ...
            switch (optionName)
            {
                case SocketOptionName.SendTimeout:    _sendTimeout    = optionValue;      break;
                case SocketOptionName.ReceiveTimeout: _receiveTimeout = optionValue;      break;
                case SocketOptionName.Broadcast:      _broadcast      = optionValue != 0; break;
            }
